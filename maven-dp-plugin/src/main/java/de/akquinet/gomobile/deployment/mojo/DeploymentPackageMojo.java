...
public class DeploymentPackageMojo extends AbstractMojo {
	 ...
	 * 
	 * @parameter property="buildDirectory" expression="${project.build.directory}"
	 * @required
	 */
	 ...
	 */
	private List<String> m_supportedProjectTypes = Arrays.asList(new String[] { "deployment-package" });
	 ...
	 * 
	 * @parameter property="remoteRepositories" expression="${project.remoteArtifactRepositories}"
	 * @required
	 */
